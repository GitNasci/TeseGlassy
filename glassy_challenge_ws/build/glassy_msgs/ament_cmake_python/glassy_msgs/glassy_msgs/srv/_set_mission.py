...
class Metaclass_SetMission_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from glassy_msgs.msg import MissionInfo
            if MissionInfo.__class__._TYPE_SUPPORT is None:
                MissionInfo.__class__.__import_type_support__()
...
class SetMission_Request(metaclass=Metaclass_SetMission_Request):
    ...
    _fields_and_field_types = {
        'mission_info': 'glassy_msgs/MissionInfo',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['glassy_msgs', 'msg'], 'MissionInfo'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from glassy_msgs.msg import MissionInfo
        self.mission_info = kwargs.get('mission_info', MissionInfo())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.mission_info != other.mission_info:
            return False
        return True
    ...
    def mission_info(self):
        """Message field 'mission_info'."""
        return self._mission_info

    @mission_info.setter
    def mission_info(self, value):
        if __debug__:
            from glassy_msgs.msg import MissionInfo
            assert \
                isinstance(value, MissionInfo), \
                "The 'mission_info' field must be a sub message of type 'MissionInfo'"
        self._mission_info = value
...
class Metaclass_SetMission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from glassy_msgs.srv import _set_mission
...
class SetMission(metaclass=Metaclass_SetMission):
    from glassy_msgs.srv._set_mission import SetMission_Request as Request
    from glassy_msgs.srv._set_mission import SetMission_Response as Response
