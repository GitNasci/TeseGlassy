...
#include "glassy_msgs/msg/detail/state__rosidl_typesupport_fastrtps_c.h"
...
using _State__ros_msg_type = glassy_msgs__msg__State;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->p_ned;
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->v_body;
    cdr.serializeArray(array_ptr, size);
  }
...
static uint32_t _State__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_glassy_msgs__msg__State(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = glassy_msgs__msg__State;
    is_plain =
      (
...
static size_t _State__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_glassy_msgs__msg__State(
