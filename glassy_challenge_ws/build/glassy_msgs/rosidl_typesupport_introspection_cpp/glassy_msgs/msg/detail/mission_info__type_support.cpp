...
{
  new (message_memory) glassy_msgs::msg::MissionInfo(_init);
}

void MissionInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<glassy_msgs::msg::MissionInfo *>(message_memory);
  typed_message->~MissionInfo();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MissionInfo_message_member_array[1] = {
  {
    "mission_mode",  // name
    ...
    offsetof(glassy_msgs::msg::MissionInfo, mission_mode),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MissionInfo_message_members = {
  ...
  1,  // number of fields
  sizeof(glassy_msgs::msg::MissionInfo),
...
{
  return &::glassy_msgs::msg::rosidl_typesupport_introspection_cpp::MissionInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, glassy_msgs, msg, MissionInfo)() {
  return &::glassy_msgs::msg::rosidl_typesupport_introspection_cpp::MissionInfo_message_type_support_handle;
}
