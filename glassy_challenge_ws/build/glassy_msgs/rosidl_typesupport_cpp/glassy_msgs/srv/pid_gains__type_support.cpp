...
static const _PidGains_Request_type_support_symbol_names_t _PidGains_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, glassy_msgs, srv, PidGains_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, glassy_msgs, srv, PidGains_Request)),
  }
};
...
{
  return &::glassy_msgs::srv::rosidl_typesupport_cpp::PidGains_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, glassy_msgs, srv, PidGains_Request)() {
  return get_message_type_support_handle<glassy_msgs::srv::PidGains_Request>();
}
...
static const _PidGains_Response_type_support_symbol_names_t _PidGains_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, glassy_msgs, srv, PidGains_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, glassy_msgs, srv, PidGains_Response)),
  }
};
...
{
  return &::glassy_msgs::srv::rosidl_typesupport_cpp::PidGains_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, glassy_msgs, srv, PidGains_Response)() {
  return get_message_type_support_handle<glassy_msgs::srv::PidGains_Response>();
}
...
static const _PidGains_type_support_symbol_names_t _PidGains_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, glassy_msgs, srv, PidGains)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, glassy_msgs, srv, PidGains)),
  }
};
...
{
  return &::glassy_msgs::srv::rosidl_typesupport_cpp::PidGains_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, glassy_msgs, srv, PidGains)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<glassy_msgs::srv::PidGains>();
}
