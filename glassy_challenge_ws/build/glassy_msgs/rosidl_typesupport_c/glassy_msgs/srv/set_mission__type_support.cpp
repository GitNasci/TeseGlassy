...
static const _SetMission_Request_type_support_symbol_names_t _SetMission_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, glassy_msgs, srv, SetMission_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, glassy_msgs, srv, SetMission_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, glassy_msgs, srv, SetMission_Request)() {
  return &::glassy_msgs::srv::rosidl_typesupport_c::SetMission_Request_message_type_support_handle;
}
...
static const _SetMission_Response_type_support_symbol_names_t _SetMission_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, glassy_msgs, srv, SetMission_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, glassy_msgs, srv, SetMission_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, glassy_msgs, srv, SetMission_Response)() {
  return &::glassy_msgs::srv::rosidl_typesupport_c::SetMission_Response_message_type_support_handle;
}
...
static const _SetMission_type_support_symbol_names_t _SetMission_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, glassy_msgs, srv, SetMission)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, glassy_msgs, srv, SetMission)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, glassy_msgs, srv, SetMission)() {
  return &::glassy_msgs::srv::rosidl_typesupport_c::SetMission_service_type_support_handle;
}
