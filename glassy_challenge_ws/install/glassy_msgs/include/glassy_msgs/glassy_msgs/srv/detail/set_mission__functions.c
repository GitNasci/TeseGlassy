...
glassy_msgs__srv__SetMission_Request__init(glassy_msgs__srv__SetMission_Request * msg)
{
  ...
  // mission_info
  if (!glassy_msgs__msg__MissionInfo__init(&msg->mission_info)) {
    glassy_msgs__srv__SetMission_Request__fini(msg);
    return false;
  }
  return true;
}
...
glassy_msgs__srv__SetMission_Request__fini(glassy_msgs__srv__SetMission_Request * msg)
{
  ...
  // mission_info
  glassy_msgs__msg__MissionInfo__fini(&msg->mission_info);
}
...
glassy_msgs__srv__SetMission_Request__are_equal(const glassy_msgs__srv__SetMission_Request * lhs, const glassy_msgs__srv__SetMission_Request * rhs)
{
  ...
  // mission_info
  if (!glassy_msgs__msg__MissionInfo__are_equal(
...
glassy_msgs__srv__SetMission_Request__create()
{
  ...
  glassy_msgs__srv__SetMission_Request * msg = (glassy_msgs__srv__SetMission_Request *)allocator.allocate(sizeof(glassy_msgs__srv__SetMission_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(glassy_msgs__srv__SetMission_Request));
  bool success = glassy_msgs__srv__SetMission_Request__init(msg);
  if (!success) {
...
glassy_msgs__srv__SetMission_Request__Sequence__init(glassy_msgs__srv__SetMission_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  glassy_msgs__srv__SetMission_Request * data = NULL;

  if (size) {
    data = (glassy_msgs__srv__SetMission_Request *)allocator.zero_allocate(size, sizeof(glassy_msgs__srv__SetMission_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = glassy_msgs__srv__SetMission_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        glassy_msgs__srv__SetMission_Request__fini(&data[i - 1]);
      }
...
glassy_msgs__srv__SetMission_Request__Sequence__fini(glassy_msgs__srv__SetMission_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      glassy_msgs__srv__SetMission_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  glassy_msgs__srv__SetMission_Request__Sequence * array = (glassy_msgs__srv__SetMission_Request__Sequence *)allocator.allocate(sizeof(glassy_msgs__srv__SetMission_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = glassy_msgs__srv__SetMission_Request__Sequence__init(array, size);
  if (!success) {
...
glassy_msgs__srv__SetMission_Request__Sequence__destroy(glassy_msgs__srv__SetMission_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    glassy_msgs__srv__SetMission_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
glassy_msgs__srv__SetMission_Request__Sequence__are_equal(const glassy_msgs__srv__SetMission_Request__Sequence * lhs, const glassy_msgs__srv__SetMission_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!glassy_msgs__srv__SetMission_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  glassy_msgs__srv__SetMission_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(glassy_msgs__srv__SetMission_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    glassy_msgs__srv__SetMission_Request * data =
      (glassy_msgs__srv__SetMission_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!glassy_msgs__srv__SetMission_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          glassy_msgs__srv__SetMission_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!glassy_msgs__srv__SetMission_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  glassy_msgs__srv__SetMission_Response * msg = (glassy_msgs__srv__SetMission_Response *)allocator.allocate(sizeof(glassy_msgs__srv__SetMission_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(glassy_msgs__srv__SetMission_Response));
  bool success = glassy_msgs__srv__SetMission_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
glassy_msgs__srv__SetMission_Response__destroy(glassy_msgs__srv__SetMission_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    glassy_msgs__srv__SetMission_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
glassy_msgs__srv__SetMission_Response__Sequence__init(glassy_msgs__srv__SetMission_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  glassy_msgs__srv__SetMission_Response * data = NULL;

  if (size) {
    data = (glassy_msgs__srv__SetMission_Response *)allocator.zero_allocate(size, sizeof(glassy_msgs__srv__SetMission_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = glassy_msgs__srv__SetMission_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        glassy_msgs__srv__SetMission_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
glassy_msgs__srv__SetMission_Response__Sequence__fini(glassy_msgs__srv__SetMission_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      glassy_msgs__srv__SetMission_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  glassy_msgs__srv__SetMission_Response__Sequence * array = (glassy_msgs__srv__SetMission_Response__Sequence *)allocator.allocate(sizeof(glassy_msgs__srv__SetMission_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = glassy_msgs__srv__SetMission_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
glassy_msgs__srv__SetMission_Response__Sequence__destroy(glassy_msgs__srv__SetMission_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    glassy_msgs__srv__SetMission_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
glassy_msgs__srv__SetMission_Response__Sequence__are_equal(const glassy_msgs__srv__SetMission_Response__Sequence * lhs, const glassy_msgs__srv__SetMission_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!glassy_msgs__srv__SetMission_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  glassy_msgs__srv__SetMission_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(glassy_msgs__srv__SetMission_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    glassy_msgs__srv__SetMission_Response * data =
      (glassy_msgs__srv__SetMission_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!glassy_msgs__srv__SetMission_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          glassy_msgs__srv__SetMission_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!glassy_msgs__srv__SetMission_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
