...
static const _SetMission_Request_type_support_symbol_names_t _SetMission_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, glassy_msgs, srv, SetMission_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, glassy_msgs, srv, SetMission_Request)),
  }
};
...
{
  return &::glassy_msgs::srv::rosidl_typesupport_cpp::SetMission_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, glassy_msgs, srv, SetMission_Request)() {
  return get_message_type_support_handle<glassy_msgs::srv::SetMission_Request>();
}
...
static const _SetMission_Response_type_support_symbol_names_t _SetMission_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, glassy_msgs, srv, SetMission_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, glassy_msgs, srv, SetMission_Response)),
  }
};
...
{
  return &::glassy_msgs::srv::rosidl_typesupport_cpp::SetMission_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, glassy_msgs, srv, SetMission_Response)() {
  return get_message_type_support_handle<glassy_msgs::srv::SetMission_Response>();
}
...
static const _SetMission_type_support_symbol_names_t _SetMission_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, glassy_msgs, srv, SetMission)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, glassy_msgs, srv, SetMission)),
  }
};
...
{
  return &::glassy_msgs::srv::rosidl_typesupport_cpp::SetMission_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, glassy_msgs, srv, SetMission)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<glassy_msgs::srv::SetMission>();
}
