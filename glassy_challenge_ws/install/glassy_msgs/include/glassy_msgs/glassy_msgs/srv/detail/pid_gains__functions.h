...
#ifndef GLASSY_MSGS__SRV__DETAIL__PID_GAINS__FUNCTIONS_H_
#define GLASSY_MSGS__SRV__DETAIL__PID_GAINS__FUNCTIONS_H_
...
/// Initialize srv/PidGains message.
/**
...
/// Create srv/PidGains message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * glassy_msgs__srv__PidGains_Request__init().
...
/// Destroy srv/PidGains message.
/**
 * It calls
 * glassy_msgs__srv__PidGains_Request__fini()
...
/// Check for srv/PidGains message equality.
/**
...
/// Initialize array of srv/PidGains messages.
/**
...
/// Finalize array of srv/PidGains messages.
/**
 * It calls
 * glassy_msgs__srv__PidGains_Request__fini()
...
/// Create array of srv/PidGains messages.
/**
 * It allocates the memory for the array and calls
 * glassy_msgs__srv__PidGains_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PidGains messages.
/**
 * It calls
 * glassy_msgs__srv__PidGains_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PidGains message array equality.
/**
...
/// Copy an array of srv/PidGains messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * glassy_msgs__srv__PidGains_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_glassy_msgs
...
/**
 * It calls
 * glassy_msgs__srv__PidGains_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_glassy_msgs
...
/**
 * It allocates the memory for the array and calls
 * glassy_msgs__srv__PidGains_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_glassy_msgs
...
/**
 * It calls
 * glassy_msgs__srv__PidGains_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GLASSY_MSGS__SRV__DETAIL__PID_GAINS__FUNCTIONS_H_
