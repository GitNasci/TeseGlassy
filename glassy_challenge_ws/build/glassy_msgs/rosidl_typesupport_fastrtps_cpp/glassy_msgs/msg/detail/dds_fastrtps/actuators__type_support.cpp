...
#include "glassy_msgs/msg/detail/actuators__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = glassy_msgs::msg::Actuators;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const glassy_msgs::msg::Actuators *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<glassy_msgs::msg::Actuators *>(
    untyped_ros_message);
...
{
  return &glassy_msgs::msg::typesupport_fastrtps_cpp::_Actuators__handle;
}
