...
#include "glassy_msgs/msg/detail/actuators__rosidl_typesupport_fastrtps_c.h"
...
using _Actuators__ros_msg_type = glassy_msgs__msg__Actuators;
...
size_t get_serialized_size_glassy_msgs__msg__Actuators(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Actuators__ros_msg_type * ros_message = static_cast<const _Actuators__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Actuators__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_glassy_msgs__msg__Actuators(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_glassy_msgs
size_t max_serialized_size_glassy_msgs__msg__Actuators(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = glassy_msgs__msg__Actuators;
    is_plain =
      (
...
static size_t _Actuators__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_glassy_msgs__msg__Actuators(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, glassy_msgs, msg, Actuators)() {
