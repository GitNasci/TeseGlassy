...
bool glassy_msgs__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("glassy_msgs.msg._state.State", full_classname_dest, 28) == 0);
  }
  glassy_msgs__msg__State * ros_message = _ros_message;
  {  // header
  ...
  {  // p_ned
    PyObject * field = PyObject_GetAttrString(_pymsg, "p_ned");
    if (!field) {
      return false;
    }
    {
  ...
  {  // v_body
    PyObject * field = PyObject_GetAttrString(_pymsg, "v_body");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 3;
      double * dest = ros_message->v_body;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject * glassy_msgs__msg__state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("glassy_msgs.msg._state");
  ...
  {  // p_ned
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "p_ned");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double * src = &(ros_message->p_ned[0]);
    memcpy(dst, src, 3 * sizeof(double));
    Py_DECREF(field);
  }
  {  // v_body
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "v_body");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->v_body[0]);
    memcpy(dst, src, 3 * sizeof(double));
    Py_DECREF(field);
  }
  {  // pitch
